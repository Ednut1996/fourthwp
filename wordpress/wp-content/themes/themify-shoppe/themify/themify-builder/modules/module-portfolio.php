	...
	public function get_styling() {
		$general = array(
			...
			array(
				...
				'class' => 'small',
				'prop' => 'color',
				'selector' => '.module-portfolio a:hover'
			),
			array(
				'id' => 'text_decoration',
				'type' => 'select',
			...
			Themify_Builder_Model::get_field_group( 'padding', '.module-portfolio .post', 'top' ),
			Themify_Builder_Model::get_field_group( 'padding', '.module-portfolio .post', 'right' ),
			Themify_Builder_Model::get_field_group( 'padding', '.module-portfolio .post', 'bottom' ),
			Themify_Builder_Model::get_field_group( 'padding', '.module-portfolio .post', 'left' ),
			Themify_Builder_Model::get_field_group( 'padding', '.module-portfolio .post', 'all' ),
			// Margin
			array(
				'type' => 'separator',
				'meta' => array('html'=>'<hr />')
			...
			Themify_Builder_Model::get_field_group( 'margin', '.module-portfolio .post', 'top' ),
			Themify_Builder_Model::get_field_group( 'margin', '.module-portfolio .post', 'right' ),
			Themify_Builder_Model::get_field_group( 'margin', '.module-portfolio .post', 'bottom' ),
			Themify_Builder_Model::get_field_group( 'margin', '.module-portfolio .post', 'left' ),
			Themify_Builder_Model::get_field_group( 'margin', '.module-portfolio .post', 'all' ),
			// Border
			array(
				'type' => 'separator',
				'meta' => array( 'html' => '<hr />' )
			...
			Themify_Builder_Model::get_field_group( 'border', '.module-portfolio .post', 'top' ),
			Themify_Builder_Model::get_field_group( 'border', '.module-portfolio .post', 'right' ),
			Themify_Builder_Model::get_field_group( 'border', '.module-portfolio .post', 'bottom' ),
			Themify_Builder_Model::get_field_group( 'border', '.module-portfolio .post', 'left' ),
			Themify_Builder_Model::get_field_group( 'border', '.module-portfolio .post', 'all' )
		);
		...
		$portfolio_title = array(
			...
			array(
				...
				'class' => 'small',
				'prop' => 'color',
				'selector' => array( '.module-portfolio .post-title:hover', '.module-portfolio .post-title a:hover' )
			),
			array(
				...
				'fields' => array(
					array(
						...
						'class' => 'xsmall',
						'prop' => 'font-size',
						'selector' => '.module-portfolio .post-title'
					),
					array(
		...
		$portfolio_meta = array(
			...
			array(
				...
				'class' => 'font-family-select',
				'prop' => 'font-family',
				'selector' => array( '.module-portfolio .post-content .post-meta', '.module-portfolio .post-content .post-meta a' )
			),
			array(
				'id' => 'font_color_meta',
				'type' => 'color',
			...
			array(
				...
				'fields' => array(
					array(
						...
						'class' => 'xsmall',
						'prop' => 'font-size',
						'selector' => '.module-portfolio .post-content .post-meta'
					),
					array(
		...
		$portfolio_date = array(
			...
			array(
				...
				'class' => 'font-family-select',
				'prop' => 'font-family',
				'selector' => array('.module-portfolio .post .post-date', '.module-portfolio .post .post-date a')
			),
			array(
				'id' => 'font_color_date',
				'type' => 'color',
			...
			array(
				...
				'class' => 'small',
				'prop' => 'color',
				'selector' => array('.module-portfolio .post .post-date:hover', '.module-portfolio .post .post-date a:hover')
			),
			array(
				...
				'fields' => array(
					array(
						...
						'class' => 'xsmall',
						'prop' => 'font-size',
						'selector' => '.module-portfolio .post .post-date'
					),
					array(
		...
		$portfolio_content = array(
			...
			array(
				...
				'class' => 'font-family-select',
				'prop' => 'font-family',
				'selector' => '.module-portfolio .post-content .entry-content'
			),
			array(
