...
final class Themify_Builder_Model {
	...
	static public function get_text_align() {
		...
		if ( is_null( $text_align ) ) {
			$text_align = array(
				...
				array( 'value' => '', 'name' => __( 'Default', 'themify' ), 'icon' => '×' )
			);
		}
	...
	static public function get_text_decoration() {
		...
		if ( is_null( $text_decoration ) ) {
			$text_decoration = array(
				...
				array( 'value' => 'none', 'name' => __( 'None', 'themify' ), 'icon' => '<span style="text-decoration:line-through;">N</span>' )
			);
		}
	 ...
	 * @return array
	 */
	static public function get_font_style() {
		...
		if ( is_null( $font_style ) ) {
			$font_style = array(
				...
				array( 'value' => 'none', 'name' => __( 'None', 'themify' ), 'icon' => 'N' )
			);
		}
	 ...
	 * @return array
	 */
	static public function get_text_transform() {
		...
		if ( is_null( $text_transform ) ) {
			$text_transform = array(
				...
				array( 'value' => '', 'name' => '', 'selected' => true, 'icon' => '×' )
			);
		}
